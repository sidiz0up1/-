...
const typeImages: Record<BodyType, string> = {
  [BodyType.TYPE0]: '/건강형.png',
  [BodyType.TYPEA]: '/상체말림형.png',
  [BodyType.TYPEB]: '/비대칭형.png',
  [BodyType.TYPEC]: '/하체 O다리형.png',
  [BodyType.TYPED]: '/골반-요추 불균형형.png',
  [BodyType.TYPEE]: '/복합 불균형형.png',
};
